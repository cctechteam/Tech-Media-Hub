      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-lg shadow-lg border border-blue-100 p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-red-800 mb-2">Form Supervisor Dashboard</h1>
            <p className="text-red-600">Monitor and manage beadle attendance reports across all forms</p>
          </div>
            ...
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-6">
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <div className="text-2xl font-bold text-blue-800">{supervisorStats.totalForms}</div>
                  <div className="text-blue-600 text-sm">Forms Monitored</div>
                </div>
                <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
                  <div className="text-2xl font-bold text-indigo-800">{supervisorStats.totalSlips}</div>
                  <div className="text-indigo-600 text-sm">Total Reports</div>
                </div>
                ...
                {Object.entries(groupedSlips).map(([form, formSlips]) => (
                  <div key={form} className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="text-xl font-semibold text-gray-800">{form}</h3>
            ...
            <div className="bg-red-600 text-white px-6 py-4">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="text-white hover:text-red-200 text-2xl font-bold w-8 h-8 flex items-center justify-center rounded-full hover:bg-red-700 transition-colors"
                >
                  ×
                </button>
              </div>
