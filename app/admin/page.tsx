...
import { FaCog, FaEnvelope, FaBars, FaTimes } from "react-icons/fa";
import ProtectedRoute from "@/components/ProtectedRoute";

export default function AdminPortal() {
  const [activeSection, setActiveSection] = useState("beadle");
  const [sidebarOpen, setSidebarOpen] = useState(false);

  const menuItems = [
    {
      id: "beadle",
      name: "Beadle Management",
      icon: <FaCog className="text-xl" />,
      description: "Manage Beadle system",
      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="flex-1 flex">
          <button
            ...
            className="md:hidden fixed bottom-6 right-6 z-50 p-4 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
            ...
            <div className="p-6">
              ...
              <div className="mt-8 p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200">
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  More admin tools and features will be added here.
                </p>
              </div>
            </div>
          </aside>
          ...
          <main className="flex-1 overflow-auto">
            {activeSection === "beadle" && (
              <div className="h-full">
                <iframe
                  src="/admin/beadle-dashboard"
                  className="w-full h-full border-0"
                  style={{minHeight: 'calc(100vh - 73px)'}}
                  title="Beadle Management Dashboard"
                />
              </div>
            )}
